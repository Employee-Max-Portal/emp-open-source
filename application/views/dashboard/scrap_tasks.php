...
<section class="panel appear-animation mt-sm"
    ...
    <header class="panel-heading">
        <h4 class="panel-title">
            <i class="fas fa-tasks"></i> <?= translate('scrap_task_logs') ?>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?= htmlspecialchars($task->reason) ?></td>
							<td><?= $duration ?></td>
            ...
            <?php if (!empty($activity_logs)): ?>
                ...
                ?>
                    <div class="noti-card">
                        ...
                        <span><strong><?= translate('reason') ?>:</strong> <?= htmlspecialchars($task->reason) ?></span>
