					...
					<h4 class="panel-title">
                        <div class="auth-pan">
                            <button class="btn btn-default btn-circle" id="authentication_btn">
                                <?php if($staff['active'] == 0): ?>
                                    <i class="fas fa-unlock-alt"></i> <?=translate('authentication_activate')?>
                                <?php else: ?>
                                    <i class="fas fa-lock"></i> <?=translate('authentication_deactivate')?>
                                <?php endif; ?>
                            </button>
                        </div>
						...
						<div class="panel-body">
							<fieldset>
									...
									<div class="col-md-4 mb-sm">
										<div class="form-group">
											...
											<?php
												...
												echo form_dropdown("branch_id", $arrayBranch, set_value('branch_id', $staff['branch_id']), "class='form-control' id='branch_id'data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
											?>
								...
								<div class="row">
									...
									<div class="col-md-4 mb-sm" id="type_div">
										<div class="form-group">
											...
											<?php
												// Define the options for employee type dropdown
												...
												// Set the current value based on the staff data (for edit mode)
												echo form_dropdown(
													'employee_type', 
													$employee_type_options, 
													set_value('employee_type', $staff['employee_type']), 
								...
								<div class="row">
									...
									<div class="col-md-4 mb-sm">
										<div class="form-group">
											<label class="control-label"><?=translate('parental_leave_enabled')?></label>
											<div class="input-group">
												<span class="input-group-addon"><i class="fas fa-baby"></i></span>
												<?php
													$parental_options = array(
														'1' => 'Enabled',
														'0' => 'Disabled'
													);
													echo form_dropdown("parental_leave_enabled", $parental_options, set_value('parental_leave_enabled', $staff['parental_leave_enabled'] ?? '1'), "class='form-control' data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
												?>
											</div>
										</div>
									</div>
								...
								<div class="row" id="customFields">
									<?php // Custom fields helper not available - skipping custom fields rendering ?>
								...
								<div class="row mb-lg">
									<div class="col-md-12 mb-sm">
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="far fa-user"></i></span>
												<input type="text" class="form-control" name="username" value="<?=set_value('username', $staff['username'])?>" readonly />
											</div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-replace mt-lg">
                    <label class="i-checks">
                        ...
                        <i></i> 
                        <?php if($staff['active'] == 0): ?>
                            <?=translate('login_authentication_activate')?>
                        <?php else: ?>
                            <?=translate('login_authentication_deactivate')?>
                        <?php endif; ?>
                    </label>
                </div>
            </div>
