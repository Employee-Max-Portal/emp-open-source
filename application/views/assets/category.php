<div class="row">
	<div class="col-md-5">
<?php if (get_permission('assets_category', 'is_add')): ?>
		<section class="panel">
...
<?php if (get_permission('assets_category', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('assets_category', 'is_add')){ echo '7'; }else{echo '12';} ?>">
		<section class="panel">
			<header class="panel-heading">
					...
					<table class="table table-bordered table-hover table-condensed mb-none">
						...
						<tbody>
							...
							<tr>
								...
								<td>
								<?php if (get_permission('assets_category', 'is_edit')): ?>
									<!-- update link -->
								...
								<?php endif; if (get_permission('assets_category', 'is_delete')): ?>	
									<!--delete link-->
									<?php echo btn_delete('assets/category_delete/' . $row['id']);?>
								<?php endif;?>
								</td>
							</tr>
							<?php
...
<div class="zoom-anim-dialog modal-block modal-block-primary mfp-hide" id="modal">
	<section class="panel">
		<?php echo form_open('assets/category_edit', array('class' => 'frm-submit')); ?>
			<header class="panel-heading">
