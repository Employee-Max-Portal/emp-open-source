	...
	<div class="panel-body">
		<div class="invoice" id="payslipPrint">
			...
			<div class="invoice-summary text-right mt-lg">
				<div class="row">
					<div class="col-lg-6 text-left mt-lg" style="padding-top: 110px;">
						<ul class="amounts">
							<li><strong><i class="fas fa-sticky-note"></i> <?php echo translate('Note'); ?> :</strong> <?php echo ($salary['remarks']); ?></li>
						</ul>
					</div>
						...
						<ul class="amounts">
							...
							<li>
								...
								if (class_exists('NumberFormatter')) {
									...
									echo currencyFormat($salary['net_salary']);
								}
								?>
							</li>
						</ul>
