<?php
//$widget = ((in_array(loggedin_role_id(), [1, 2, 3, 5])) ? 'col-md-6' : 'col-md-offset-3 col-md-6');
$widget = ((in_array(loggedin_role_id(), [1])) ? 'col-md-6' : 'col-md-offset-3 col-md-6');
	...
	<div class="col-md-12">
		<section class="panel">
			...
			<div class="panel-body">
                ...
                <?php if (in_array(loggedin_role_id(), [1])) : ?>
