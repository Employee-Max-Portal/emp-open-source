		...
		<div class="tab-content">
			<div id="edit" class="tab-pane active">
			    <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('gross_salary'); ?></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="gross_salary" id="gross_salary" value="<?= $template['gross_salary'] ?>" placeholder="Gross Salary Here" />
...
$(document).ready(function () {
    ...
    // Optional auto fill for gross estimate
    let basic = parseFloat($("#basic_salary").val()) || 0;
    if (basic > 0) {
        let estimated_gross = (basic / 0.55).toFixed(2);
        $("#gross_salary").val(estimated_gross);
    }
});
