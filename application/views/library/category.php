<div class="row">
	<div class="col-md-5">
<?php if (get_permission('policy_category', 'is_add')): ?>
		<section class="panel">
...
<?php if (get_permission('policy_category', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('policy_category', 'is_add')){ echo '7'; }else{echo '12';} ?>">
		<section class="panel">
			<header class="panel-heading">
					...
					<table class="table table-bordered table-hover table-condensed mb-none">
						...
						<tbody>
							...
							<tr>
								...
								<td>
								<?php if (get_permission('policy_category', 'is_edit')): ?>
									<!-- update link -->
								...
								<?php endif; if (get_permission('policy_category', 'is_delete')): ?>	
									<!--delete link-->
