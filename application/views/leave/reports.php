					...
					<?php endif; ?>
						<div class="<?=$widget?> mb-sm">
							<div class="form-group">
				                ...
				                <?php
									$role_list = array('all' => translate('all')) + $this->app_lib->getRoles([1,6]);
									echo form_dropdown("role_id", $role_list, set_value('role_id'), 
				...
				<table class="table table-bordered table-condensed table-hover mb-none table-export" >
					...
					<tbody>
						...
						<tr>
							...
							<td><?php
								$getStaff = $this->db->select('name')->where('id', $row['approved_by'])->get('staff')->row_array();
								echo $getStaff['name'];
								?>
								</td>
							<td>
